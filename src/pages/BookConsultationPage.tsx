...
import { Clock, Video, Languages, ArrowRight, CalendarClock, Mail, CircleCheck as CheckCircle2, MessageCircle, Sparkles } from 'lucide-react';
          ...
          <PageContainer>
            <div className="mx-auto max-w-2xl text-center">
              <motion.div
                ...
                className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary-50 text-primary-600"
              >
              ...
              <motion.p
                ...
                {...fadeUp}
              >
                Thank you, {form.student_name.split(' ')[0] || 'there'}. We have received your
                request and will reply by email within one to two business days to schedule a time
                that works for you.
              </motion.p>

              <motion.div
                className="mx-auto mt-10 max-w-md rounded-2xl border border-neutral-100 bg-[#FAFAF9] p-6 text-left"
                {...fadeUp}
              >
                ...
                <ul className="mt-4 space-y-3 text-sm leading-relaxed text-neutral-600">
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 font-semibold text-primary-500">1.</span>
                    <span>
                      We review your request and match you with the right advisor.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 font-semibold text-primary-500">2.</span>
                    <span>
                      We email you within 1–2 business days with a few suggested times.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 font-semibold text-primary-500">3.</span>
                    <span>
                      You confirm a time, and we send a calendar invite with the meeting link.
                    </span>
                  </li>
                </ul>
              </motion.div>
