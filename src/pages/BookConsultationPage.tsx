...
export function BookConsultationPage() {
  ...
  if (status === 'success') {
    const firstName = form.student_name.split(' ')[0] || 'there';
    const nextSteps = [
      {
        step: '01',
          ...
          <PageContainer>
            <div className="mx-auto max-w-3xl text-center">
              ...
              <motion.p
                ...
                {...fadeUp}
              >
                Hi {firstName}, your request is in good hands. A real advisor — not an automated
                system — will read it and reply to you personally within one to two business days.
                Until then, here is exactly what to expect.
              </motion.p>
            </div>
          </PageContainer>
        </section>
